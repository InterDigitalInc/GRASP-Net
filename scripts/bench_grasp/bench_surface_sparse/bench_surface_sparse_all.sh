...
# Main configurations
CHECKPOINTS="${HOME_DIR}/results/grasp_surface_sparse/r01.pth ${HOME_DIR}/results/grasp_surface_sparse/r02.pth ${HOME_DIR}/results/grasp_surface_sparse/r03.pth ${HOME_DIR}/results/grasp_surface_sparse/r04.pth ${HOME_DIR}/results/grasp_surface_sparse/r05.pth"
