...
# Main configurations
CHECKPOINTS="${HOME_DIR}/results/grasp_lidar_ford/r01.pth ${HOME_DIR}/results/grasp_lidar_ford/r02.pth ${HOME_DIR}/results/grasp_lidar_ford/r03.pth ${HOME_DIR}/results/grasp_lidar_ford/r04.pth ${HOME_DIR}/results/grasp_lidar_ford/r05.pth"
